...
/**
 * Devuelve el número de solicitudes de permisos (no vacaciones) pendientes
 * de los subordinados (badge rojo del enlace "Permisos generales").
 * Equivale a la acción `numeroSoliVacas`.
 */
